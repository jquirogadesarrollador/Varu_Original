<%@ Page Title="" Language="C#" MasterPageFile="~/formularios.master" AutoEventWireup="true" CodeFile="actividadesRseGlobal.aspx.cs" Inherits="_actividadesRseGlobal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="div_contenedor_grilla_resultados">
                    <div class="grid_seleccionar_registros">
                        <asp:GridView ID="GridView_RESULTADOS_BUSQUEDA" runat="server" Width="885px" AutoGenerateColumns="False"
                            DataKeyNames="ID_ACTIVIDAD" OnRowCommand="GridView_RESULTADOS_BUSQUEDA_RowCommand"
                            AllowPaging="True" 
    ...
    <asp:Panel ID="Panel_InformacionActividad" runat="server">
        <div class="div_espaciador"></div>
        <div class="div_contenedor_formulario">
            <div class="div_cabeza_groupbox">
            ...
            <div class="div_contenido_groupbox">
                ...
                <asp:Panel ID="Panel_Actividad" runat="server">
                    <div class="div_espaciador"></div>
                    ...
                    <div class="div_contenido_groupbox_gris">
                        <table class="table_control_registros">
                            <tr>
                                ...
                                <td class="td_der">
                                    <asp:TextBox ID="TextBox_Nombre" runat="server" Width="210px" 
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownList_Tipo" runat="server" 
                                        ValidationGroup="ADICIONAR" Width="140px">
                                    </asp:DropDownList>
                                </td>
                                <td class="td_izq">
                                    Sector:
                                ...
                                <td class="td_der">
                                    <asp:DropDownList ID="DropDownList_Sector" runat="server" 
                                        ValidationGroup="ADICIONAR" Width="140px">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <asp:Panel ID="Panel_Estado" runat="server">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator_DropDownList_EstadoActividad"
                                            ControlToValidate="DropDownList_EstadoActividad" Display="None" ErrorMessage="<b>Campo Requerido faltante</b><br />El Estado de la Actividad es requerida."
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator_DropDownList_Tipo"
                            ControlToValidate="DropDownList_Tipo" Display="None" ErrorMessage="<b>Campo Requerido faltante</b><br />El TIPO de la actividad es requerido."
                            ValidationGroup="ADICIONAR" />
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator_DropDownList_Sector"
                            ControlToValidate="DropDownList_Sector" Display="None" ErrorMessage="<b>Campo Requerido faltante</b><br />El SECTOR de la actividad es requerido."
                            ValidationGroup="ADICIONAR" />
                        <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender_DropDownList_Sector"
                            TargetControlID="RequiredFieldValidator_DropDownList_Sector" HighlightCssClass="validatorCalloutHighlight" />
                        ...
                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator_TextBox_Descripcion"
                            ControlToValidate="TextBox_Descripcion" Display="None" ErrorMessage="<b>Campo Requerido faltante</b><br />La DESCRIPCIÓN de la Actividad es requerida."
                            ValidationGroup="ADICIONAR" />
