<%@ Page Title="" Language="C#" MasterPageFile="~/formularios.master" AutoEventWireup="true" CodeFile="Cartera.aspx.cs" Inherits="comercial_Cartera" %>
                    ...
                    <div class="grid_seleccionar_registros">
                        <asp:GridView ID="GridView_HOJA_DE_TRABAJO" runat="server" Width="885px" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Fecha_Radicacion" HeaderText="Fecha Radicacion"/>
                                <asp:BoundField DataField="Fecha_Vence" HeaderText="Fecha vence"/>
                                <asp:BoundField DataField="Dias_Vencidos" HeaderText="Dias vencidos"/>
                                <asp:BoundField DataField="Dias_Radicacion" HeaderText="Dias radicacion"/>
