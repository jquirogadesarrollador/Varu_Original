<%@ Page Title="" Language="C#" MasterPageFile="~/formularios.master" AutoEventWireup="true" CodeFile="condicionesEconomicasSertempo.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel_FORMULARIO" runat="server">
        ...
        <div class="div_contenedor_formulario">
            <div class="div_cabeza_groupbox">
                Condiciones económicas generales</div>
            <div class="div_contenido_groupbox">
                        ...
                        <td valign="top" style="width:50%">
                            ...
                            <div class="div_contenido_groupbox_gris">
                                ...
                                <asp:RangeValidator ID="RangeValidator_TextBox_AD_PENSION" runat="server" 
                                    ...
                                    ControlToValidate="TextBox_AD_PENSION" Display="None" ValidationGroup="CREAR"></asp:RangeValidator>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBox_AD_CESANTIA" runat="server" Width="50px" 
                                                ValidationGroup="CREAR" MaxLength="9" Height="22px"></asp:TextBox>
                                        </td>
                                        <td>
                            ...
                            <div class="div_contenido_groupbox_gris">
                                <asp:Panel ID="Panel_SERVICIOS_COMPLEMENTARIOS_ADICIONAR" runat="server">
                                    ...
                                    <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender_TextBox_SER_VALOR"
                                            ...
                                            HighlightCssClass="validatorCalloutHighlight" />
                                    <%--<asp:RangeValidator ID="RangeValidator_TextBox_SER_VALOR" runat="server" 
                                        ErrorMessage="<b>Datos erroneos</b><br />El VALOR no tiene formato correcto." 
                                        MaximumValue="999999999" MinimumValue="1" Type="Integer"
                                        ControlToValidate="TextBox_SER_VALOR" Display="None" ValidationGroup="SERVICIOCOMP"></asp:RangeValidator>
                                    <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtenderTextBox_SER_VALOR_1"
                                            TargetControlID="RangeValidator_TextBox_SER_VALOR"
                                            HighlightCssClass="validatorCalloutHighlight" />--%>
                                    <ajaxToolkit:FilteredTextBoxExtender
