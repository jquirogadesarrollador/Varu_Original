<%@ Page Title="" Language="C#" MasterPageFile="~/formularios.master" AutoEventWireup="true"
    CodeFile="derogaciones.aspx.cs" Inherits="seleccion_derogaciones" %>
                        ...
                        <div class="div_contenedor_grilla_resultados">
                            <div class="grid_seleccionar_registros">
                                <asp:GridView ID="GridView_RESULTADOS_BUSQUEDA" runat="server" Width="885px" AutoGenerateColumns="False"
                                    DataKeyNames="ID_REQUERIMIENTO,ID_SOLICITUD,NUM_DOC_IDENTIDAD" OnSelectedIndexChanged="GridView_RESULTADOS_BUSQUEDA_SelectedIndexChanged"
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GridView_Documentos" runat="server" Width="860px" AutoGenerateColumns="False"
                                                        DataKeyNames="ID_CONTROL_REQUISITOS,ID_PRUEBA,ID_DOCUMENTO">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Derogado">
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="CheckBox_Derogado" runat="server" AutoPostBack="False" />
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass="columna_grid_centrada" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Observicaciones">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="TextBox_Observaciones" runat="server" TextMode="MultiLine" Width="300px"
                                                                        Height="40px" ValidationGroup="ADICIONAR"></asp:TextBox>
                                                                </ItemTemplate>
